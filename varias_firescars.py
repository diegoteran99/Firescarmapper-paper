...
class FireScarMapper(QgsProcessingAlgorithm):
    ...
    def addRasterLayer(self, file_path, layer_name, group, context):
        ...
        if "FireScar" in layer_name:
            # Obtener los valores mínimos y máximos de la capa para el renderer
            provider = layer.dataProvider()
            ...
            # Definir los intervalos de color
            color_ramp.setColorRampItemList([
                QgsColorRampShader.ColorRampItem(min_value, QColor(255, 255, 255)),
                QgsColorRampShader.ColorRampItem(max_value, QColor(0, 0, 0))
            ])
        ...
        # Refrescar la capa para aplicar los cambios
...
class LayerSelectionDialog(QDialog):
    ...
    def get_description(self):
        ...
        return """
            ...
            - In the pre- and post-fire image layers, the red and blue bands may be swapped. You can fix this manually by adjusting the symbology properties of each layer.<br>
            - For a better visualization of the generated fire scar, open the layer's properties and select "Accept" to automatically adjust the color contrast.
